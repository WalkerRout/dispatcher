...
Binary expects path `./resources/dispatch.toml` exists, will be automatically generated when built with cargo (via build.rs).
> **Unix specific**: binary expects path `./daemon` exists, likewise will be autogenerated.
